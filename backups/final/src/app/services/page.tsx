...
export const metadata: Metadata = buildMetadata({
  title: "NEMT Services — Wheelchair, Stretcher & Ambulatory Transport Boston",
  description:
    "Complete non-emergency medical transport: wheelchair vans, stretcher/gurney, ambulatory, dialysis, hospital discharge & bariatric. MassHealth accepted. Greater Boston.",
  path: "/services",
  keywords: ["NEMT services Boston", "wheelchair transport", "stretcher ambulance", "dialysis transport MA"],
});
