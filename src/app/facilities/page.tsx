...
import { FACILITY_BENEFITS, INSURANCE_PLANS } from "@/lib/constants";
...
export const metadata: Metadata = buildMetadata({
  title: "NEMT Facility Partnerships — Hospitals & Dialysis Centers",
  description:
    "Partner with McCall Ambulance for hospital discharge, dialysis, and SNF transport. Dedicated dispatch, real-time ETAs, MassHealth billing. Greater Boston.",
  path: "/facilities",
  keywords: ["NEMT facility partner", "hospital discharge transport", "dialysis center NEMT Boston"],
});
